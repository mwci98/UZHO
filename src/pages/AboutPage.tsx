      ...
      <section className="py-16 bg-[#F6F8F7] border-y border-[#E2E8E5]">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <div className="mt-6 flex items-center gap-5 rounded-2xl border border-[#E2E8E5] bg-white p-4 shadow-sm max-w-xl">
              <img src="/assets/president.jpg" alt="Vezokho Chotso, President of Uzho Cultural Society" className="w-24 h-28 rounded-xl object-cover object-top border border-[#E2E8E5]" />
              <div>
                <h3 className="text-xl font-bold text-[#17251F]">Vezokho Chotso</h3>
                <p className="mt-1 text-sm text-[#57655E]">Elected leadership</p>
              </div>
            </div>
          </div>
        </div>
